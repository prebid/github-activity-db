...
down_revision: str | Sequence[str] | None = "01421d8dfaeb"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("PENDING", "RESOLVED", "PERMANENT", name="syncfailurestatus"),
            nullable=False,
        ),
        ...
        sa.UniqueConstraint(
            "repository_id", "pr_number", "status", name="uq_repo_pr_pending_status"
        ),
    )
